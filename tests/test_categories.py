...
@pytest.mark.asyncio
async def test_create_category(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_create_child_category(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_list_categories(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_get_category(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_get_nonexistent_category(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_update_category(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_delete_category(client: AsyncClient, sample_category_data: dict) -> None:
...
@pytest.mark.asyncio
async def test_list_root_categories(client: AsyncClient, sample_category_data: dict) -> None:
